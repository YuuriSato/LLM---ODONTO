        ...
        for attempt in range(attempts):
            ...
            try:
                ...
                if attempt + 1 == attempts:
                    raise AnalysisValidationError("Resposta do Gemini nao passou pela validacao de schema e evidencias.") from exc
...
def analyze_integrity(image: Path, forensic_evidence: LocalEvidence) -> IntegrityAnalysis:
    ...
    return GeminiIntegrityAnalyzer(GeminiClient(settings)).analyze_integrity(image, forensic_evidence)
